...
uses
  Classes, SysUtils, Forms, Dialogs, StdCtrls, ComCtrls, ExtCtrls, Types, LCLTranslator, Controls;
...
type
  ...
  TformOptions = class(TForm)
    ...
    procedure editMouseWheel0(Sender: TObject; Shift: TShiftState; WheelDelta: Integer; MousePos: TPoint; var Handled: Boolean);
...
begin
  ...
  chkbAutoStripSpace.Checked      := Config.AutoStripTailSpace;
...
begin
  ...
  Config.RecentCountLimit      := StrToIntDef(editRecentCountLimit.Text, DefSearchCountLimit);
  Config.SearchCountLimit      := StrToIntDef(editSearchCountLimit.Text, DefSearchCountLimit);
  Config.AutoStripTailSpace    := chkbAutoStripSpace.Checked;
...
procedure TformOptions.editMouseWheel0(Sender: TObject; Shift: TShiftState; WheelDelta: Integer; MousePos: TPoint; var Handled: Boolean);
var
  Num: Integer;
begin
...
procedure TformOptions.editMouseWheel1(Sender: TObject; Shift: TShiftState; WheelDelta: Integer; MousePos: TPoint; var Handled: Boolean);
var
  Num: Integer;
begin
...
procedure TformOptions.GetLanguage;
var
  Index: integer;
  Lang: string;
begin
