...
begin
  ...
  chkbDoReplace.Caption      := Res_TextReplace;
...
begin
  ...
  if combSearch.Text <> '' then begin
    ...
    else while Config.RecentSearch.Count >= Config.RecentCountLimit do
  ...
  if (combReplace.Text <> '') then begin
    ...
    else while Config.RecentReplace.Count >= Config.RecentCountLimit do
